	...
	cin >> Variant;
        switch (Variant) {
            case 1: {
                ...
                cout << "First coefficient: ";
                cin >> First_coeff;
                cout << "Second coefficient: ";
                cin >> Second_coeff;
                cout << "Third coefficient: ";
                cin >> Third_coeff;
                ...
                if (D < 0) {
                    ...
                    cout << "The discriminant is zero. The quadratic equation has 1 real root" << " " << "x = " << x_0
                         << endl;
                } else if (D > 0) {
            ...
            case 2: {
                ...
                cin >> Size; // Ввод размера квадратной матрицы
            ...
            case 4: {
                ...
                Output_Matrix(Lines, Columns, mT);
                break;
            }
            case 5: {
